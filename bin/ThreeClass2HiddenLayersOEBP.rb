### VERSION "nCore"
## ../nCore/bin/ThreeClass2HiddenLayersOEBP.rb
...
class Experiment
  ...
  def createNetworkAndTrainer
    ...
    # puts network.to_s
    theTrainer = ThreeClass2HiddenSupervisorOEBP.new(examples, network, args)
...
experiment = Experiment.new("3Cls2HidOEBP ThreeClass2HiddenLayersOEBP", baseRandomNumberSeed)
